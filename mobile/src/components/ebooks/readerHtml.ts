/**
 * WebView EPUB reader: JSZip + epubjs from jsDelivr (head script tags, parser order), EPUB bytes embedded as base64.
  ...
  function boot() {
    ...
    book.ready
      .then(function () {
        ...
        return book.locations.generate(1200).catch(function () { return null; });
      })
      .then(function () {
