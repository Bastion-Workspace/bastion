...
def build_outline_document_guidance() -> str:
    ...
    return (
        ...
        "  - ### Beats - Detailed bullet point events (MAXIMUM 150 beats per chapter!)\n"
        ...
        "    * Beats may include optional guidance for internal thoughts, realizations, or shifts in perception when the style guide encourages interiority (e.g. \"- She realizes he lied — shift from trust to doubt\"); describe the internal moment without quoted dialogue.\n"
        "  - ### Scenes (optional) - Groups of beats for fiction generation; format: Scene: Name — Beats 1-3 (optional hint)\n\n"
        ...
        "**150-BEAT LIMIT ENFORCEMENT (CRITICAL):**\n"
        "- Each chapter MUST have a MAXIMUM of 150 beats\n"
        ...
        "  2. **Check if adding would exceed 150** - If (existing beats + new beats) > 150, you MUST prune\n"
        ...
        "- Beat count metadata is shown in context: \"(METADATA: Beat count: {count}/150)\"\n"
        "- Warnings appear at 145+ beats, hard limit at 150\n\n"
        ...
        "4. **Check 150-beat limit** - If adding would exceed 150, prune less important beats first\n"
