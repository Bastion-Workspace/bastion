...
from document_mcp.tools.metadata_search_tool import MetadataSearchTool, MetadataSearchInput
from document_mcp.tools.query_expansion_tool import QueryExpansionTool, QueryExpansionInput
from document_mcp.tools.filename_search_tool import FilenameSearchTool, FilenameSearchInput
from document_mcp.tools.entity_search_tool import EntitySearchTool, EntitySearchInput
from document_mcp.tools.entity_extraction_tool import EntityExtractionTool, EntityExtractionInput
from document_mcp.tools.knowledge_graph_analytics_tool import KnowledgeGraphAnalyticsTool, GraphAnalyticsInput
from document_mcp.tools.web_search_tool import WebSearchTool, WebSearchInput
from document_mcp.tools.web_content_tool import WebContentTool, WebContentInput
from document_mcp.tools.web_search_ingestion_tool import WebSearchIngestionTool, WebSearchIngestionInput
from document_mcp.tools.web_search_analysis_tool import WebSearchAnalysisTool, WebSearchAnalysisInput
from document_mcp.tools.web_ingest_selected_tool import WebIngestSelectedTool, WebIngestSelectedInput
# Research planning tool removed - migrated to LangGraph subgraph workflows
from document_mcp.tools.document_summarization_tool import DocumentSummarizationTool, DocumentSummarizationInput
...
class MCPServer:
    ...
    async def initialize(self):
        ...
        try:
            ...
            from document_mcp.tools.coding_assistant_tool import CodingAssistantTool
    ...
    async def _validate_tool_input(self, tool_name: str, tool_input: Dict[str, Any]) -> Any:
        ...
        try:
            if tool_name == "search_documents":
                ...
                from document_mcp.tools.coding_assistant_tool import CodingAssistantInput
