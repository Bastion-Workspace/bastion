...
from document_mcp.schemas.tool_schemas import ToolResponse, ToolError
from pydantic import BaseModel, Field

if TYPE_CHECKING:
    from document_mcp.tools.web_search_tool import WebSearchResult as WebSearchResultType
...
class WebSearchIngestionTool:
    ...
    async def _perform_web_search(self, input_data: WebSearchIngestionInput) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            from document_mcp.tools.web_search_tool import WebSearchInput
    ...
    async def _process_and_ingest_result(self, search_result: "WebSearchResultType", input_data: WebSearchIngestionInput) -> IngestedWebResult:
        ...
        try:
            ...
            if input_data.ingest_content:
                ...
                from document_mcp.tools.web_content_tool import WebContentInput
