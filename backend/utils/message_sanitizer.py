...
Mirrors llm-orchestrator/orchestrator/utils/message_sanitizer.py so the backend
can sanitize persisted assistant content without importing the orchestrator package.
"""
