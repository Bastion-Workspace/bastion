...
async def run_migration(migration_name: str):
    ...
    if migration_name == "042":
    ...
    elif migration_name in (
        "157",
        "157_remove_rss_and_deep_research_builtin_playbooks",
        ...
        "159",
        "159_fix_document_folders_global_update_rls",
        "document_folders_global_update_rls",
    ):
        sql_file = "159_fix_document_folders_global_update_rls.sql"
        ...
        if candidate.exists():
            ...
            logger.info(
                ...
                "158/default_playbook_prompt, 159/document_folders_global_update_rls, 130/messaging_improvements "
