...
-- Same DDL is in backend/sql/01_init.sql for fresh installs.
-- Run on existing DB from host: docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/sql/migrations/042_add_agent_factory_tables.sql
-- ========================================
