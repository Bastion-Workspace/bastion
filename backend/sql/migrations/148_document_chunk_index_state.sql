...
-- Fresh Compose DBs: included via backend/sql/03_document_chunk_index_state.sql (init order after 02_*).
-- Existing DB missing columns: docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/sql/migrations/148_document_chunk_index_state.sql
