...
--
-- Usage:
-- docker exec -i <postgres-container> psql -U bastion_user -d bastion_knowledge_base < backend/postgres_init/migrations/026_fix_teams_select_policy_for_creation.sql
