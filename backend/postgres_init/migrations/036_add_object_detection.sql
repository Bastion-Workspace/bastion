...
--
--   docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/postgres_init/migrations/036_add_object_detection.sql
--
-- Or from host with psql:
--   psql -U postgres -d bastion_knowledge_base -f backend/postgres_init/migrations/036_add_object_detection.sql
--
