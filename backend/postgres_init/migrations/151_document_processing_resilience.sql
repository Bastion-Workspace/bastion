...
-- Fresh Compose DBs: included via backend/postgres_init/04_document_processing_resilience.sql (init order after 03_*).
-- Existing DB: docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/postgres_init/migrations/151_document_processing_resilience.sql
