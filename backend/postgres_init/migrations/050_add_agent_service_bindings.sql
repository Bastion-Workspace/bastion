...
-- Run on existing DB: docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/postgres_init/migrations/050_add_agent_service_bindings.sql
-- ========================================
