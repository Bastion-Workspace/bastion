...
-- Run on existing DB: docker exec -i bastion-postgres psql -U postgres -d bastion_knowledge_base < backend/postgres_init/migrations/043_add_agent_schedules.sql
-- ========================================
