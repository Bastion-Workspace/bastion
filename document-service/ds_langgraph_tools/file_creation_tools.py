...
async def create_user_file(
    ...
    **SECURITY**: Only creates files in user's collection (collection_type='user')
    ...
    try:
        ...
        from ds_services.file_manager_service import FileManagerService
        from ds_services.models.file_placement_models import (
        ...
        from ds_models.api_models import DocumentType, DocumentCategory
