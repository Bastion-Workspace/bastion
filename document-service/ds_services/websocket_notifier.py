...
class WebSocketNotifier:
    ...
    async def notify_document_status_update(
        self,
        document_id: str,
        status: str,
        folder_id: str,
        ...
        """Alias used by file_manager (rename, etc.)."""
        return await self.notify_processing_status_update(
            document_id, status, folder_id, user_id=user_id
        )
