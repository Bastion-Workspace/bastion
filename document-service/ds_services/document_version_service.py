...
from ds_db import document_version_repository as version_repo
...
async def rollback_to_version(
    ...
    try:
        ...
        if exempt:
            ...
            from shims.services.celery_tasks.document_tasks import reprocess_document_after_save_task
            from ds_models.api_models import ProcessingStatus
            await document_service.document_repository.update_status(
